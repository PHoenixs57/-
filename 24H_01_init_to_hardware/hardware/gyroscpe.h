...
//陀螺仪包大小
#define UART_Gyroscpe_PACKET_SIZE (44)
...
extern volatile uint8_t wt61_rx_buffer[UART_Gyroscpe_PACKET_SIZE];
extern volatile uint8_t wt61_rx_index;
extern volatile uint8_t wt61_data_ready ;

//调试之后会取消extern 
extern volatile uint8_t wt61_data_buffer[WT61_FRAME_LENGTH * 3];
